    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-card rounded-2xl border border-border p-6">
          <div className="flex items-center justify-between mb-5">
            ...
            <Link href="/dashboard/admin-panel/shipments"
        ...
        <div className="bg-card rounded-2xl border border-border p-6">
          <div className="flex items-center justify-between mb-5">
            ...
            <Link href="/dashboard/admin-panel/warehouses"
              className="text-xs font-medium text-amber-600 hover:underline flex items-center gap-1">
          ...
          <div className="mt-6 pt-5 border-t border-border">
            <div className="flex items-center justify-between">
              ...
              <Link href="/dashboard/admin-panel/team"
      ...
      <div className="bg-card rounded-2xl border border-border p-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            { label:'New Shipment', href:'/dashboard/admin-panel/shipments', Icon: Truck,       color:'hover:bg-amber-50 hover:border-amber-300 hover:text-amber-700' },
            { label:'Add Vendor',   href:'/dashboard/admin-panel/vendors',   Icon: Users,       color:'hover:bg-violet-50 hover:border-violet-300 hover:text-violet-700' },
            { label:'Manage Stock', href:'/dashboard/admin-panel/warehouses',Icon: Package,     color:'hover:bg-cyan-50 hover:border-cyan-300 hover:text-cyan-700' },
            { label:'Funds Ledger', href:'/dashboard/admin-panel/ledger',    Icon: ReceiptText, color:'hover:bg-emerald-50 hover:border-emerald-300 hover:text-emerald-700' },
          ].map(a => (
