...
// import { User, Stethoscope, ShieldCheck, Cross, AlertCircle, Truck, Wallet, Check } from 'lucide-react';
...
//   { value: 'admin',       label: 'Admin',           Icon: ShieldCheck, desc: 'Full system access and management',             color: 'border-violet-400 bg-violet-50 text-violet-700'  },
...
// NOTE: 'admin' intentionally removed — admin accounts are invite-only,
// never self-registered from this public form.
const ROLES = [
  { value: 'user',        label: 'Patient',        Icon: User,        desc: 'Book appointments, track health records',       color: 'border-indigo-400 bg-indigo-50 text-indigo-700'  },
  { value: 'doctor',      label: 'Doctor',          Icon: Stethoscope, desc: 'Manage appointments and patients',              color: 'border-emerald-400 bg-emerald-50 text-emerald-700'},
  { value: 'logistics',   label: 'Logistics',       Icon: Truck,       desc: 'Supply chain and shipment tracking',            color: 'border-amber-400 bg-amber-50 text-amber-700'     },
...
// Roles that require admin approval before they can access their dashboard
        ...
        <div className="w-full max-w-md animate-fade-in-up">
          ...
          <div className="bg-card rounded-2xl shadow-xl border border-border p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Account type selector — 4 options now (admin removed), 2x2 grid */}
              <div>
                <label className="block text-sm font-medium text-foreground mb-2">Account type</label>
              ...
              {/* Approval notice for doctor/logistics */}
